    ...
    static let privacyPolicy = LegalDocument(
        ...
        sections: [
            ...
            Section(heading: "5. Apple Health / HealthKit", paragraphs: [
                "Apple Health integration is optional. With your permission, DailyDil may read supported Apple Health values such as heart rate, heart-rate variability, resting heart rate, breathing rate, and available Apple Watch rhythm data. With your permission, DailyDil may write supported reading summaries back to Apple Health. Face frames and custom waveforms are not written. You can change Apple Health permissions at any time in the Health app."
            ]),
