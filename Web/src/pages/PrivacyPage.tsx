...
export default function PrivacyPage() {
  return (
    <DocLayout title="Privacy Policy" updated="July 22, 2026">
      <p>
        This Privacy Policy explains how the DailyDil iOS app and website (“DailyDil”, “the
        app”, “we”, “us”) handle information. DailyDil is a wellness screening app, not a
      ...
      <h2>1. Summary</h2>
      <ul>
        <li>DailyDil does not require an account, name, email, or password.</li>
        ...
        <li>DailyDil does not use advertising SDKs or third-party tracking analytics.</li>
      </ul>

      <h2>2. Information Processed by the App</h2>
      <p>
        DailyDil may process camera, Apple Health, and optional profile
      ...
      <h2>3. Face Data</h2>
      <p>
        During a facial rPPG check, DailyDil uses the front camera video stream to locate a face
        region and process subtle color changes that can be used to estimate pulse for a wellness
        screening. This is the only face data collected by the app. DailyDil does not create Face
      ...
      <p>
        ...
        to the app database, not written to Apple Health, not uploaded to DailyDil servers, and not
      ...
      <p>
        DailyDil stores readings and optional profile values locally on your device in an
        ...
        export them, or remove the app. You can delete local DailyDil data from the app’s Data &
        Privacy screen.
      </p>

      <h2>5. Apple Health / HealthKit</h2>
      <p>
        Apple Health integration is optional. With your permission, DailyDil may read supported
        Apple Health values such as heart rate, heart-rate variability, resting heart rate,
        breathing rate, and available Apple Watch rhythm data. With your permission,
        DailyDil may write supported reading summaries back to Apple Health. Face frames, custom
      ...
      <p>
        DailyDil does not sell personal information or face data. We do not share face data with
      ...
      <p>
        DailyDil is not directed to children under 13, and we do not knowingly collect personal
      ...
      <p>
        ...
        a company holds about you. Most DailyDil data is stored only on your device, so you can
      ...
      <h2>10. Security</h2>
      <p>
        DailyDil uses on-device processing where practical, local encrypted storage for readings,
        iOS Keychain storage for encryption keys, and encrypted network connections for web content.
        No method of storage or transmission is completely secure, but DailyDil minimizes risk by
        avoiding account creation and avoiding storage of raw face frames.
      </p>

      <h2>11. Medical Disclaimer</h2>
      <p>
        DailyDil is provided for wellness and informational purposes only. It is not medical
      ...
      <h2>13. Contact Us</h2>
      <p>
        If you have any questions about this Privacy Policy or DailyDil, contact us at{' '}
